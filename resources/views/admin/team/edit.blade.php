    ...
    <div class="card shadow mb-3">
        <div class="card-body">
            <form action="{{ route('admin.team.edit', ['team' => $team->id]) }}" method="post"
                enctype="multipart/form-data" id="add-team">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="fb" id="fb" value="{{ $team->fb }}"
                            class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label for="tw">Twitter URL</label>
                        <input type="text" name="tw" id="tw" value="{{ $team->tw }}"
                            class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label for="li">Linkedin URL</label>
                        <input type="text" name="li" id="li" value="{{ $team->li }}"
                            class="form-control">
                    </div>
                    ...
                    <div class="col-md-2">
                        <input type="number" value="{{ $team->sn }}" name="SN" placeholder="SN" id="sn"
                            min="0" class="form-control">
                    </div>
                    <div class="col-md-6 py-2">
                        <button class="btn btn-primary">Save Member</button>

                        <a href="{{ route('admin.team.index', ['type' => $team->type->id]) }}"
