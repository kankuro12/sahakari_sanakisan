            ...
            <form action="{{ route('admin.event.edit',['event'=>$event->id]) }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="file"  name="photo" id="photo" accept="image/*" data-default-file="{{asset($event->image)}}">
                    </div>
                    <div class="col-md-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="addr" id="addr" class="form-control" required value="{{$event->addr}}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
